...
import { Book, Calendar, ChevronRight, Sparkles, Lock, BarChart2, FileText } from "lucide-react";
    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <p className="text-lg md:text-xl text-orange-800 mb-8">
          Capture your toughts, track your moods, and reflect on your journey in a secure space.
        </p>

        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-top from-orange-50 via-transparent to-transparent pointer-events-none z-10"/>
